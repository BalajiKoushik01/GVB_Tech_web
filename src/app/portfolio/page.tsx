                                    ...
                                    <GlassCard className="p-0 overflow-hidden group h-full flex flex-col cursor-pointer border-transparent hover:border-white/20">
                                        ...
                                        <div className="p-6 flex-1 flex flex-col">
                                            <div className="flex gap-2 mb-4">
                                                <span className="text-xs font-semibold px-3 py-1 bg-accent-start/20 text-accent-start rounded-full">
                                                    {project.category}
                                                </span>
                                            </div>
                                            <h3 className="text-2xl font-bold mb-3 group-hover:text-accent-start transition-colors">{project.title}</h3>
                                            <p className="text-foreground/70 text-sm mb-6 flex-1">{project.desc}</p>
