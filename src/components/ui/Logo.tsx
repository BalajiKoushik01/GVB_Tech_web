        ...
        <div className={cn("flex items-center gap-2 md:gap-3 group", className)}>
            ...
            {showText && (
                <div className="flex flex-col justify-center transform transition-all duration-500">
                    <span className="text-xl md:text-2xl font-black tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-300 to-white bg-[length:200%_auto] animate-shimmer">
                        GVB <span className="text-gvb-blue drop-shadow-[0_0_8px_rgba(0,163,255,0.4)]">TECH</span>
                    </span>
                    <span className="text-[0.45rem] md:text-[0.5rem] uppercase font-bold tracking-[0.15em] text-slate-400 max-w-[120px] md:max-w-[140px] leading-[1.2] mt-0.5">
